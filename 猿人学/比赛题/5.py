...
jscode = """const _$Tk = require('crypto-js');
// window对象
var _0x4e96b4 = {};
...
def get_page(page):
    ...
    headers = {
        ...
        'Cookie': f"m={cookie_m}; RM4hZBv0dDon443M={cookie_r}; qpfccr=true; no-alert=true;"
    }
    result = requests.get(url, headers=headers)
    print(result.text)

if __name__ == '__main__':
    r = ctx.call("get_result")
    m = r[0]
    f = r[1]
    cookie_m = r[2]
    cookie_r = r[3]
