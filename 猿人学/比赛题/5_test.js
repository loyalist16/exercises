const _$Tk = require('crypto-js');
// window对象
var _0x4e96b4 = {};
_0x4e96b4['_$pr'] = Array();
...
function _0x11a7a2(_0x193f00, _0x1cfe89) {
    ...
    for (_0x1badc3 = 0x0; _0x1badc3 < _0x193f00["length"]; _0x1badc3 += _0x42fb36)
        _0x38ca59 = _0x3e0c38,
            ...
            _0x257ec6 = _0x4b459d(_0x257ec6, _0x3e0c38, _0xdb4d2c, _0x1724c5, _0x193f00[_0x1badc3 + 0xb], 0xa, -0x42c50dcb),
...
function get_result() {
    ...
    var m = _0x2d5f5b()["toString"]();
    _0x4e96b4['_$Jy'] = -405537848;
    _0x4e96b4['_$tT'] = -660478335;
    _0x4e96b4['_$6_'] = -389564586;
    var cookie_m = _0x474032(m);
    _0x4e96b4['_$pr']['push'](cookie_m);
    console.log("pr: ", _0x4e96b4['_$pr']);
    var _$Ww = _$Tk['enc']['Utf8']['parse'](_0x4e96b4['_$pr']['toString']());
    var qf = _$Tk['enc']['Utf8']['parse'](btoa(m)['slice'](0, 16));
    var _$Wu = _$Tk['AES']['encrypt'](_$Ww, qf, {
        'mode': _$Tk['mode']['ECB'],
        'padding': _$Tk['pad']['Pkcs7']
    });
    // console.log(_$Ww);
    var r = _$Wu.toString();
    console.log(m, f, cookie_m, r);
    return [m, f, cookie_m, r];
}
...
// _0x4e96b4['_$tT'] = -660478335;
// _0x4e96b4['_$6_'] = -389564586;
// console.log(_0x474032(1613803004575));
// [_$Wa,_0x474032(_$Wa),_0x4e96b4['_$Jy'],_0x4e96b4['_$tT'],_0x4e96b4['_$6_'],_0x4e96b4['_$pr']]

// var m = "1613803004575";
// var pr = ["673305fde43bfe58f65849e5eed392f5", "4f9cbc1da9e5de857463a1bf18edf188", "8942e94150015ff5abed1f8d0f65b301", "affb122c1dae0f20f14b3c25fe877f32", "774998784a7644abee7d7cf611294c97"];
// var _$Ww = _$Tk['enc']['Utf8']['parse'](pr['toString']());
// var qf = _$Tk['enc']['Utf8']['parse'](btoa(m)['slice'](0, 16));
// var _$Wu = _$Tk['AES']['encrypt'](_$Ww, qf, {
//         'mode': _$Tk['mode']['ECB'],
//         'padding': _$Tk['pad']['Pkcs7']
